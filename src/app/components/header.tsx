    ...
    <header className="text-gray-600 body-font">
      <nav className="fixed top-0 left-0 z-[999] w-full text-white bg-indigo-600 p-3 flex items-center justify-between gap-5">
        ...
        <div className="relative dropdown-container">
          ...
          <div
            className={`absolute mt-2 w-40 bg-white shadow-lg rounded-lg z-20 transform transition-all duration-300 ease-in-out ${dropdownOpen
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-white z-[1000] transition-all">
          ...
          <div className="bg-white w-[400px] p-8 rounded-lg shadow-2xl relative overflow-hidden">
            ...
            <div className="flex mb-6 justify-center rounded-full overflow-hidden">
              <button
                className={`px-4 py-2 transition-all duration-300 ${!isSignUp ? "bg-indigo-600 text-white" : "bg-gray-100"
                  }`}
            ...
            <div
              className={`relative transition-all duration-500 ease-in-out ${isSignUp ? "h-[520px]" : "h-[260px]"
                }`}
            >
              {/* Sign In Form */}
              <form
                className={`absolute w-full transition-all duration-500 ${isSignUp
